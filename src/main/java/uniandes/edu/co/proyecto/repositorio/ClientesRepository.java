...
public interface ClientesRepository extends JpaRepository<Clientes, Integer> {
    ...
    void insertarCliente(@Param("tipo_documento") String tipoDocumento, @Param("num_documento") Integer numDocumento, @Param("nombre") String nombre, @Param("correo") String correo);
